define('modules/index/main', function(require, exports, module) {

  
  var logger = require('modules/index/log'),
      log = logger.log,
      autosave = require('modules/index/autosave'),
      checkcode = require('modules/index/checkcode'),
      alarm = require('modules/index/alarm'),
      R = require('modules/index/rest'),
      grabber = require('modules/index/grabber'),
      tpl = {
          trainOption: require('modules/index/tpl/trainOption_tpl'),
          trainItem: require('modules/index/tpl/trainItem_tpl'),
          passenger: require('modules/index/tpl/passenger_tpl'),
          passengerOpt: require('modules/index/tpl/passengerOpt_tpl'),
          availableTicket: require('modules/index/tpl/availableTicket_tpl'),
          ticketResign: require('modules/index/tpl/ticketResign_tpl')
      };
